import type { ReviewData, ReviewComment } from "./types.js";
 ...
 */
function formatTestCasesTable(testCases: TestCase[]): string {
 ...
 */
export function buildPrompt(data: ReviewData, testCases?: TestCase[]): string {
